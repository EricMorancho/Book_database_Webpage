    ...
    <div class="container">
        <div class="row">
            <div class="col-10 col-md-12 offset-1 offset-md-0">
                <h1>Welcome to the greatest book database on the internet!</h1>
                <h5 class="mt-4 mb-4">Search for Books, Manga or Comics from all around the world</h5>
                ...
                <div class="mb-5">
                    <RouterLink to="/books" class="mt-5"><button class="btn btn-dark">Enter our Library</button>
                    </RouterLink>
                </div>
            </div>
        </div>
